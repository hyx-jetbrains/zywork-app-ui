        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <UserDetailTableMain ref="table" v-on:searchTable="searchTable" v-on:showEditModal="showEditModal" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
        <UserDetailAddEditModal ref="addEditModal" v-on:add="add" v-on:edit="edit"/>
...
<script>
    ...
    import UserDetailTableMain from './UserDetailTableMain.vue'
    import UserDetailAddEditModal from './UserDetailAddEditModal.vue'
