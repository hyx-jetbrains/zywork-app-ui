        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsPicTableMain ref="table" v-on:searchTable="searchTable" v-on:showEditModal="showEditModal" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
        <GoodsPicAddEditModal ref="addEditModal" v-on:add="add" v-on:edit="edit"/>
...
<script>
    ...
    import GoodsPicTableMain from './GoodsPicTableMain.vue'
    import GoodsPicAddEditModal from './GoodsPicAddEditModal.vue'
