        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCommissionTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCommissionTableMultiple from './GoodsCommissionTableMultiple.vue'
    ...
    export default {
        name: 'GoodsCommissionMainMultiple',
        components: {
            GoodsCommissionTableMultiple,
