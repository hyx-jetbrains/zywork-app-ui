...
<script>
    ...
    export default {
        name: 'GoodsCommissionTableMain',
        data() {
            return {
                urls: {
                    searchUrl: '/goods-commission/admin/pager-cond',
                    activeUrl: '/goods-commission/admin/active',
                    removeUrl: '/goods-commission/admin/remove/'
                },
                pager: {
                    pageNo: 1,
                    pageSize: 10,
