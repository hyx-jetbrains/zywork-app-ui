<template>
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始商品评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束商品评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	...
	<i-col span="11">
	<FormItem prop="commentLevelMin">
	<InputNumber v-model="searchForm.commentLevelMin" placeholder="请输入开始评论等级" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="commentLevelMax">
	<InputNumber v-model="searchForm.commentLevelMax" placeholder="请输入结束评论等级" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
	...
	<i-col span="11">
	<FormItem prop="commentRateMin">
	<InputNumber v-model="searchForm.commentRateMin" placeholder="请输入开始评分星级" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="commentRateMax">
	<InputNumber v-model="searchForm.commentRateMax" placeholder="请输入结束评分星级" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	...
	<Input v-model="searchForm.comments" placeholder="请输入评论详情"/>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="追加评论" prop="appendComment">
	<Input v-model="searchForm.appendComment" placeholder="请输入追加评论"/>
</FormItem>
</i-col>
</Row>
<Row>
	...
	<Input v-model="searchForm.reply" placeholder="请输入回复详情"/>
</FormItem>
</i-col><i-col span="12">
...
quantityMax: null, 
commentLevel: null,
commentLevelMin: null, 
commentLevelMax: null, 
commentRate: null,
commentRateMin: null, 
commentRateMax: null, 
comments: null,
