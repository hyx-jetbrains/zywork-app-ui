        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCommentTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCommentTableSingle from './GoodsCommentTableSingle.vue'
