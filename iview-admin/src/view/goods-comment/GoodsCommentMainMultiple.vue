        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCommentTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCommentTableMultiple from './GoodsCommentTableMultiple.vue'
    ...
    export default {
        name: 'GoodsCommentMainMultiple',
        components: {
            GoodsCommentTableMultiple,
