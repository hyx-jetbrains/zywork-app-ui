        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <AccountDetailTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import AccountDetailTableMultiple from './AccountDetailTableMultiple.vue'
    ...
    export default {
        name: 'AccountDetailMainMultiple',
        components: {
            AccountDetailTableMultiple,
