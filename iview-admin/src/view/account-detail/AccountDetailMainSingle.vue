        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <AccountDetailTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import AccountDetailTableSingle from './AccountDetailTableSingle.vue'
