        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <AdvertisementTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import AdvertisementTableSingle from './AdvertisementTableSingle.vue'
