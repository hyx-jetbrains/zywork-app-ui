        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <AdvertisementTableShow ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import AdvertisementTableShow from './AdvertisementTableShow.vue'
    ...
    export default {
        name: 'AdvertisementMainShow',
        components: {
            AdvertisementTableShow,
