        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <AdvertisementTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import AdvertisementTableMultiple from './AdvertisementTableMultiple.vue'
    ...
    export default {
        name: 'AdvertisementMainMultiple',
        components: {
            AdvertisementTableMultiple,
