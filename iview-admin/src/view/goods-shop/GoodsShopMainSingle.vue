        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsShopTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsShopTableSingle from './GoodsShopTableSingle.vue'
