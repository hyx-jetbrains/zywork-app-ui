        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsShopCertificationTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsShopCertificationTableMultiple from './GoodsShopCertificationTableMultiple.vue'
    ...
    export default {
        name: 'GoodsShopCertificationMainMultiple',
        components: {
            GoodsShopCertificationTableMultiple,
