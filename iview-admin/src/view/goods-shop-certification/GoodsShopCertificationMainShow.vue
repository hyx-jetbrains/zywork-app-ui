        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsShopCertificationTableShow ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsShopCertificationTableShow from './GoodsShopCertificationTableShow.vue'
    ...
    export default {
        name: 'GoodsShopCertificationMainShow',
        components: {
            GoodsShopCertificationTableShow,
