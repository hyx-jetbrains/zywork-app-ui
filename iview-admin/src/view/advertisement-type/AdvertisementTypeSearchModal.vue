<template>
    <div>
        <Modal v-model="modal.search" title="高级搜索" width="860">
            <Form ref="searchForm" :model="searchForm" :label-width="80">
                <Row>
	<i-col span="12">
	<FormItem label="广告类型编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始广告类型编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束广告类型编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
	...
	<Input v-model="searchForm.title" placeholder="请输入类型名称"/>
</FormItem>
</i-col>
</Row>
<Row>
	...
	<Input v-model="searchForm.code" placeholder="请输入类型代码"/>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="类型描述" prop="description">
	<Input v-model="searchForm.description" placeholder="请输入类型描述"/>
</FormItem>
</i-col>
</Row>
<Row>
    ...
    export default {
        ...
        data() {
            return {
                ...
                urls: {
                    searchUrl: '/advertisement-type/admin/pager-cond'
                },
                searchForm: {
                    pageNo: 1,
                    pageSize: 10,
