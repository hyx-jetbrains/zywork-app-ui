        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ShippingAddressTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import ShippingAddressTableSingle from './ShippingAddressTableSingle.vue'
