        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ShippingAddressTableShow ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import ShippingAddressTableShow from './ShippingAddressTableShow.vue'
    ...
    export default {
        name: 'ShippingAddressMainShow',
        components: {
            ShippingAddressTableShow,
