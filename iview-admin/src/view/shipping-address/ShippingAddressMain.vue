        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ShippingAddressTableMain ref="table" v-on:searchTable="searchTable" v-on:showEditModal="showEditModal" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
        <ShippingAddressAddEditModal ref="addEditModal" v-on:add="add" v-on:edit="edit"/>
...
<script>
    ...
    import ShippingAddressTableMain from './ShippingAddressTableMain.vue'
    import ShippingAddressAddEditModal from './ShippingAddressAddEditModal.vue'
    ...
    export default {
        ...
        components: {
            ShippingAddressTableMain,
            ShippingAddressAddEditModal,
