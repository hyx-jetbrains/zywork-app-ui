    ...
    <div>
        <Modal v-model="modal.search" title="高级搜索" width="860">
            <Form ref="searchForm" :model="searchForm" :label-width="80">
                <Row>
	<i-col span="12">
	<FormItem label="秒杀编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始秒杀编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束秒杀编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	<i-col span="12">
	<FormItem label="秒杀价格"><Row>
	<i-col span="11">
	<FormItem prop="seckillPriceMin">
	<InputNumber v-model="searchForm.seckillPriceMin" placeholder="请输入开始秒杀价格" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="seckillPriceMax">
	<InputNumber v-model="searchForm.seckillPriceMax" placeholder="请输入结束秒杀价格" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="秒杀总数量"><Row>
	<i-col span="11">
	<FormItem prop="seckillTotalMin">
	<InputNumber v-model="searchForm.seckillTotalMin" placeholder="请输入开始秒杀总数量" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="seckillTotalMax">
	<InputNumber v-model="searchForm.seckillTotalMax" placeholder="请输入结束秒杀总数量" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	<i-col span="12">
	<FormItem label="秒杀结束时间"><Row>
	<i-col span="11">
	<FormItem prop="seckillEndTimeMin">
	<DatePicker @on-change="searchForm.seckillEndTimeMin=$event" :value="searchForm.seckillEndTimeMin" placeholder="请输入开始秒杀结束时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="seckillEndTimeMax">
	<DatePicker @on-change="searchForm.seckillEndTimeMax=$event" :value="searchForm.seckillEndTimeMax" placeholder="请输入结束秒杀结束时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
</Row>
</FormItem>
...
goodsSkuIdMax: null, 
seckillPrice: null,
seckillPriceMin: null, 
seckillPriceMax: null, 
seckillTotal: null,
seckillTotalMin: null, 
seckillTotalMax: null, 
beginTime: null,
beginTimeMin: null, 
beginTimeMax: null, 
endTime: null,
...
endTimeMax: null, 
seckillEndTime: null,
seckillEndTimeMin: null, 
seckillEndTimeMax: null, 
version: null,
versionMin: null, 
versionMax: null, 
createTime: null,
