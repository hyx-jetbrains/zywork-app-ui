        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <FundsWithdrawTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import FundsWithdrawTableMultiple from './FundsWithdrawTableMultiple.vue'
    ...
    export default {
        name: 'FundsWithdrawMainMultiple',
        components: {
            FundsWithdrawTableMultiple,
