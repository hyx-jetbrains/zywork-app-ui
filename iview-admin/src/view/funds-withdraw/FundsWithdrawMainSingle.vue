        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <FundsWithdrawTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import FundsWithdrawTableSingle from './FundsWithdrawTableSingle.vue'
