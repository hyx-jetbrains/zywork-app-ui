        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ArticleCommentTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import ArticleCommentTableMultiple from './ArticleCommentTableMultiple.vue'
