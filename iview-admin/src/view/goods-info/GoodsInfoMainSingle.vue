        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsInfoTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsInfoTableSingle from './GoodsInfoTableSingle.vue'
