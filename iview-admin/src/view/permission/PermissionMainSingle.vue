        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <PermissionTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import PermissionTableSingle from './PermissionTableSingle.vue'
