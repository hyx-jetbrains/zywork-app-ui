...
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">商品图片编号：</span><span v-text="form.picId"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">上架状态：</span><span v-text="form.shelfStatus"></span></i-col>
