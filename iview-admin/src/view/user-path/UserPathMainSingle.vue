        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <UserPathTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import UserPathTableSingle from './UserPathTableSingle.vue'
