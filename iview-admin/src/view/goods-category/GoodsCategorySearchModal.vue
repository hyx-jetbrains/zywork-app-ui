  ...
  <div>
    <Modal v-model="modal.search" title="高级搜索" width="860">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <Row>
          <i-col span="12">
            <FormItem label="商品类目编号">
              <Row>
                <i-col span="11">
                  <FormItem prop="idMin">
                    <InputNumber
                      v-model="searchForm.idMin"
                      placeholder="请输入开始商品类目编号"
                      style="width: 100%;"
                    />
                  </FormItem>
                </i-col>
              ...
              <Row>
                <i-col span="11">
                  <FormItem prop="isHotMin">
                    <InputNumber
                      v-model="searchForm.isHotMin"
                      placeholder="请输入开始是否热门"
                      style="width: 100%;"
                    />
                  </FormItem>
                </i-col>
                ...
                <i-col span="11">
                  <FormItem prop="isHotMax">
                    <InputNumber
                      v-model="searchForm.isHotMax"
                      placeholder="请输入结束是否热门"
                      style="width: 100%;"
                    />
                  </FormItem>
                </i-col>
