<template>
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始商品类目编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束商品类目编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="类目父编号"><Row>
	<i-col span="11">
	<FormItem prop="parentIdMin">
	<InputNumber v-model="searchForm.parentIdMin" placeholder="请输入开始类目父编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="parentIdMax">
	<InputNumber v-model="searchForm.parentIdMax" placeholder="请输入结束类目父编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	...
	<FormItem label="类目级别"><Row>
	<i-col span="11">
	<FormItem prop="categoryLevelMin">
	<InputNumber v-model="searchForm.categoryLevelMin" placeholder="请输入开始类目级别" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="categoryLevelMax">
	<InputNumber v-model="searchForm.categoryLevelMax" placeholder="请输入结束类目级别" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
