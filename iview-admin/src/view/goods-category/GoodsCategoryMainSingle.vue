        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCategoryTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCategoryTableSingle from './GoodsCategoryTableSingle.vue'
