        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCategoryTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCategoryTableMultiple from './GoodsCategoryTableMultiple.vue'
    ...
    export default {
        name: 'GoodsCategoryMainMultiple',
        components: {
            GoodsCategoryTableMultiple,
