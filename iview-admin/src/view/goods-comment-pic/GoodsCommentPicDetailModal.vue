    ...
    <div>
        <Modal v-model="modal.detail" title="详情" width="760">
            <div class="detail-info">
                <Row>
	<i-col span="11"><span class="detail-title">评论图片编号：</span><span v-text="form.id"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">评论编号：</span><span v-text="form.commentId"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">图片URL：</span><span v-text="form.picUrl"></span></i-col>
