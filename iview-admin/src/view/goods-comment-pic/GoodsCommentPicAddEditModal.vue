    ...
    <div>
        <Modal v-model="modal.add" title="添加" :mask-closable="false" @on-visible-change="changeModalVisibleResetForm('addForm', $event)" width="760">
            <Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
                <Row>
	<i-col span="12">
	<FormItem label="评论编号" prop="commentId">
	<InputNumber v-model="form.commentId" placeholder="请输入评论编号" style="width: 100%;"/>
</FormItem>
	</i-col><i-col span="12">
    ...
    export default {
        ...
        data() {
            return {
                ...
                urls: {
                    addUrl: '/goods-comment-pic/admin/save',
                    batchAddUrl: '/goods-comment-pic/admin/batch-save',
                    editUrl: '/goods-comment-pic/admin/update',
                    batchEditUrl: '/goods-comment-pic/admin/batch-update'
                },
                form: {
                    id: null,
commentId: null,
