<template>
    <div>
        <Modal v-model="modal.search" title="高级搜索" width="860">
            <Form ref="searchForm" :model="searchForm" :label-width="80">
                <Row>
	<i-col span="12">
	<FormItem label="评论图片编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始评论图片编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束评论图片编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
	...
	<i-col span="11">
	<FormItem prop="commentIdMin">
	<InputNumber v-model="searchForm.commentIdMin" placeholder="请输入开始评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="commentIdMax">
	<InputNumber v-model="searchForm.commentIdMax" placeholder="请输入结束评论编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
    ...
    export default {
        ...
        data() {
            return {
                ...
                urls: {
                    searchUrl: '/goods-comment-pic/admin/pager-cond'
                },
                searchForm: {
                    pageNo: 1,
                    pageSize: 10,
