    ...
    <div>
        <Modal v-model="modal.detail" title="详情" width="760">
            <div class="detail-info">
                <Row>
	<i-col span="11"><span class="detail-title">领券编号：</span><span v-text="form.id"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">用户编号：</span><span v-text="form.userId"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">优惠券编号：</span><span v-text="form.couponId"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">优惠券状态：</span><span v-text="form.couponStatus"></span></i-col>
