    ...
    <div>
        <Modal v-model="modal.search" title="高级搜索" width="860">
            <Form ref="searchForm" :model="searchForm" :label-width="80">
                <Row>
	<i-col span="12">
	<FormItem label="领券编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始领券编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束领券编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	...
	<InputNumber v-model="searchForm.couponIdMin" placeholder="请输入开始优惠券编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="couponIdMax">
	<InputNumber v-model="searchForm.couponIdMax" placeholder="请输入结束优惠券编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="优惠券状态"><Row>
	<i-col span="11">
	<FormItem prop="couponStatusMin">
	<InputNumber v-model="searchForm.couponStatusMin" placeholder="请输入开始优惠券状态" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="couponStatusMax">
	<InputNumber v-model="searchForm.couponStatusMax" placeholder="请输入结束优惠券状态" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
    ...
    export default {
        ...
        data() {
            return {
                ...
                urls: {
                    searchUrl: '/goods-user-coupon/admin/pager-cond'
                },
                searchForm: {
                    pageNo: 1,
                    pageSize: 10,
...
couponIdMax: null, 
couponStatus: null,
couponStatusMin: null, 
couponStatusMax: null, 
version: null,
versionMin: null, 
versionMax: null, 
createTime: null,
