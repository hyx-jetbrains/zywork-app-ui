        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsUserCouponTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsUserCouponTableSingle from './GoodsUserCouponTableSingle.vue'
