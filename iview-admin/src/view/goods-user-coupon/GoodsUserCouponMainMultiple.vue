        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsUserCouponTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsUserCouponTableMultiple from './GoodsUserCouponTableMultiple.vue'
    ...
    export default {
        name: 'GoodsUserCouponMainMultiple',
        components: {
            GoodsUserCouponTableMultiple,
