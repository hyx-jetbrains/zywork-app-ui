        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <MessageTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import MessageTableMultiple from './MessageTableMultiple.vue'
