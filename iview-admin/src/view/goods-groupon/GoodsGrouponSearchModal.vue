    ...
    <div>
        <Modal v-model="modal.search" title="高级搜索" width="860">
            <Form ref="searchForm" :model="searchForm" :label-width="80">
                <Row>
	<i-col span="12">
	<FormItem label="团购编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始团购编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束团购编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	...
	<FormItem label="拼团价格"><Row>
	<i-col span="11">
	<FormItem prop="grouponPriceMin">
	<InputNumber v-model="searchForm.grouponPriceMin" placeholder="请输入开始拼团价格" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="grouponPriceMax">
	<InputNumber v-model="searchForm.grouponPriceMax" placeholder="请输入结束拼团价格" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<Row>
	<i-col span="12">
	<FormItem label="成团人数"><Row>
	<i-col span="11">
	<FormItem prop="grouponPersonCountMin">
	<InputNumber v-model="searchForm.grouponPersonCountMin" placeholder="请输入开始成团人数" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="grouponPersonCountMax">
	<InputNumber v-model="searchForm.grouponPersonCountMax" placeholder="请输入结束成团人数" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
goodsSkuIdMax: null, 
grouponPrice: null,
grouponPriceMin: null, 
grouponPriceMax: null, 
grouponPersonCount: null,
grouponPersonCountMin: null, 
grouponPersonCountMax: null, 
beginTime: null,
beginTimeMin: null, 
beginTimeMax: null, 
endTime: null,
