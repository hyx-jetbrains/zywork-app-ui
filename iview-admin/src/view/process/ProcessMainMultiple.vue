        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ProcessTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import ProcessTableMultiple from './ProcessTableMultiple.vue'
