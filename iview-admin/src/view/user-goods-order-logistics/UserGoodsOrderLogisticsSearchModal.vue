...
<Row>
	...
	<InputNumber v-model="searchForm.goodsOrderLogisticsIsActiveMin" placeholder="请输入开始是否激活" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="goodsOrderLogisticsIsActiveMax">
	<InputNumber v-model="searchForm.goodsOrderLogisticsIsActiveMax" placeholder="请输入结束是否激活" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<script>
    export default {
        name: 'UserGoodsOrderLogisticsSearch',
        data() {
            return {
                modal: {
                    search: false
...
goodsOrderLogisticsIsActiveMin: null, 
goodsOrderLogisticsIsActiveMax: null, 
