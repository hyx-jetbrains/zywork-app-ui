        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <ModuleTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import ModuleTableMultiple from './ModuleTableMultiple.vue'
