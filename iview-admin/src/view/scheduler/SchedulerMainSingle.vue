        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <SchedulerTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import SchedulerTableSingle from './SchedulerTableSingle.vue'
