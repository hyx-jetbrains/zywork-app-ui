        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCartTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCartTableSingle from './GoodsCartTableSingle.vue'
