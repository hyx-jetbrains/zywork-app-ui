<template>
  <div>
    ...
    <ActivitiInstanceDetailModal ref="detailModal"/>
    <ActivitiInstanceSearchModal ref="searchModal" v-on:searchTable="searchTable"/>
...
import ActivitiInstanceTableMain from './ActivitiInstanceTableMain.vue'
import ActivitiInstanceDetailModal from './ActivitiInstanceDetailModal.vue'
import ActivitiInstanceSearchModal from './ActivitiInstanceSearchModal.vue'
import ProcessMainSingle from '@/view/process/ProcessMainSingle.vue'
export default {
  name: 'ActivitiInstanceMain',
  components: {
    ActivitiInstanceTableMain,
    ActivitiInstanceDetailModal,
    ActivitiInstanceSearchModal,
    ProcessMainSingle
  },
  data() {
    return {
