        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsOrderLogisticsTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsOrderLogisticsTableMultiple from './GoodsOrderLogisticsTableMultiple.vue'
    ...
    export default {
        name: 'GoodsOrderLogisticsMainMultiple',
        components: {
            GoodsOrderLogisticsTableMultiple,
