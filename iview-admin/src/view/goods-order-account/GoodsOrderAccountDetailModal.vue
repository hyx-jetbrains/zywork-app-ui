    ...
    <div>
        <Modal v-model="modal.detail" title="详情" width="760">
            <div class="detail-info">
                <Row>
	<i-col span="11"><span class="detail-title">订单账目编号：</span><span v-text="form.id"></span></i-col>
...
<Row>
	<i-col span="11"><span class="detail-title">交易编号：</span><span v-text="form.transactionNo"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">总金额：</span><span v-text="form.totalAmount"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">实付金额：</span><span v-text="form.payAmount"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">总优惠金额：</span><span v-text="form.discountAmount"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">平台优惠金额：</span><span v-text="form.platDiscountAmount"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">店铺优惠金额：</span><span v-text="form.shopDiscountAmount"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">店铺分账金额：</span><span v-text="form.shopAmount"></span></i-col>
