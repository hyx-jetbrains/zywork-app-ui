        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsCouponTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsCouponTableMultiple from './GoodsCouponTableMultiple.vue'
