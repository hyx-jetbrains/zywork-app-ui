    ...
    <div>
        <Modal v-model="modal.detail" title="详情" width="760">
            <div class="detail-info">
                <Row>
	<i-col span="11"><span class="detail-title">类别编号：</span><span v-text="form.id"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">类别父编号：</span><span v-text="form.parentId"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">类别名称：</span><span v-text="form.title"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">类别描述：</span><span v-text="form.description"></span></i-col>
