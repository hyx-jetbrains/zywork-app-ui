<template>
	...
	<FormItem label="类别父编号"><Row>
	<i-col span="11">
	<FormItem prop="parentIdMin">
	<InputNumber v-model="searchForm.parentIdMin" placeholder="请输入开始类别父编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="parentIdMax">
	<InputNumber v-model="searchForm.parentIdMax" placeholder="请输入结束类别父编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
