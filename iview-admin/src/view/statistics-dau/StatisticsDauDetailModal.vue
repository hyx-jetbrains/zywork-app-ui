    ...
    <div>
        <Modal v-model="modal.detail" title="详情" width="760">
            <div class="detail-info">
                <Row>
	<i-col span="11"><span class="detail-title">DAU编号：</span><span v-text="form.id"></span></i-col>
<i-col span="2"></i-col><i-col span="11"><span class="detail-title">DAU：</span><span v-text="form.dau"></span></i-col>

</Row>
<Row>
	<i-col span="11"><span class="detail-title">统计时间：</span><span v-text="form.statisticsTime"></span></i-col>
