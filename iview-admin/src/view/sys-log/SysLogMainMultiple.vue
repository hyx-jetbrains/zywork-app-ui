        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <SysLogTableMultiple ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import SysLogTableMultiple from './SysLogTableMultiple.vue'
