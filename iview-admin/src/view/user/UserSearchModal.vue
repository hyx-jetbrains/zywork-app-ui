...
<Row>
	...
	<Input v-model="searchForm.email" placeholder="请输入用户邮箱"/>
</FormItem>
</i-col><i-col span="12">
	<FormItem label="登录密码" prop="password">
	<Input v-model="searchForm.password" placeholder="请输入登录密码"/>
</FormItem>
</i-col>
</Row>
<Row>
	...
	<Input v-model="searchForm.salt" placeholder="请输入加密盐值"/>
</FormItem>
</i-col><i-col span="12">
