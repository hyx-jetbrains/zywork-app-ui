        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsAttributeTableShow ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsAttributeTableShow from './GoodsAttributeTableShow.vue'
    ...
    export default {
        name: 'GoodsAttributeMainShow',
        components: {
            GoodsAttributeTableShow,
