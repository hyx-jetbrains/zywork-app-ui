        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsAttributeTableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import GoodsAttributeTableSingle from './GoodsAttributeTableSingle.vue'
