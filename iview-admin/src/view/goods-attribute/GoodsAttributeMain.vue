        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <GoodsAttributeTableMain ref="table" v-on:searchTable="searchTable" v-on:showEditModal="showEditModal" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
        <GoodsAttributeAddEditModal ref="addEditModal" v-on:add="add" v-on:edit="edit"/>
...
<script>
    ...
    import GoodsAttributeTableMain from './GoodsAttributeTableMain.vue'
    import GoodsAttributeAddEditModal from './GoodsAttributeAddEditModal.vue'
    ...
    export default {
        ...
        components: {
            GoodsAttributeTableMain,
            GoodsAttributeAddEditModal,
